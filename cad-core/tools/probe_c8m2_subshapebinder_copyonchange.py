...
def native_probe_contract(fixture: dict[str, Any]) -> dict[str, Any]:
    ...
    if not isinstance(objects, list):
        raise ValueError("C8-M2 native probe fixture must use top-level Objects")
    for spec in objects:
        ...
        return {
            "fixture_group": property_payload(properties.get("FixtureGroup")) or "c8m2",
    ...
    raise ValueError("C8-M2 native probe fixture is missing CadCore::NativeProbe object")
