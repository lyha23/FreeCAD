...
class CadCoreP8FeatureTest(ExpectedFixtureAssertions, CadCoreFixtureTestCase):
    ...
    def test_c5m10_part_sweep_located_profile_contract_keeps_wrapper_evidence_while_cad_core_builds(self) -> None:
        ...
        self.assert_part_sweep_history(result, "PipeSpine", ["SketchPipeProfile"], transition="Transformed")
        self.assertEqual(
        ...
        self.assertIn("do not fabricate shape_summary from cad-core output", evidence["collector_policy"])
    ...
    def test_c5m10_part_sweep_combined_advanced_contract_and_diagnostic_priority(self) -> None:
        ...
        self.assertEqual(combined["shape"], "occt_shell")
        ...
        self.assertEqual(evidence["error"], "OCCError: NCollection_Array1::Value")
        self.assertEqual(evidence["failed_stage"], "build")
        self.assertIn("do not fabricate combined expected from cad-core output", evidence["collector_policy"])
        self.assertEqual(
            evidence["depends_on"],
    ...
    def test_c6m6_part_geomplate_projected_curve2d_no_initial_surface_is_source_backed_blocker(self) -> None:
        ...
        self.assertEqual(geomplate["curve_constraint_count"], 4)
        self.assertEqual(geomplate["point_constraint_count"], 1)
        self.assertNotIn("initial_surface", {item["kind"] for item in source_evidence})
        projected = [item for item in source_evidence if item["kind"] == "projected_curve2d"]
        self.assertEqual(len(projected), 1)
        self.assertEqual(projected[0]["object"], "BoundaryA")
        self.assertEqual(projected[0]["surface_object"], "SupportPlane")
        ...
        self.assertEqual(
            known_gap["cad_core_contract"]["status"],
    ...
    def test_c3m6_assembly_distance_type_s6_supported_expected_batch_matches_native(self) -> None:
        ...
        accepted_s6_cases = {
            ...
            "assembly-distance-cylinder-cone-default-boundary": (
                "CylinderCone",
                "ASMTPlanarJoint",
                "offset",
                1.5,
            ...
            "assembly-distance-cone-cone-default-boundary": (
                "ConeCone",
                "ASMTPlanarJoint",
                "offset",
                1.5,
            ...
            "assembly-distance-cone-torus-default-boundary": (
                "ConeTorus",
                "ASMTPlanarJoint",
                "offset",
                1.5,
            ...
            "assembly-distance-cone-sphere-default-boundary": (
                "ConeSphere",
                "ASMTPlanarJoint",
                "offset",
                1.5,
            ...
            "assembly-distance-point-cone-default-boundary": (
                "PointCone",
                "ASMTPlanarJoint",
                "offset",
                1.5,
            ...
            "assembly-distance-point-torus-default-boundary": (
                "PointTorus",
                "ASMTPlanarJoint",
                "offset",
                1.5,
            ...
            "assembly-distance-line-sphere-default-boundary": (
                "LineSphere",
                "ASMTPlanarJoint",
                "offset",
                1.5,
            ...
            "assembly-distance-line-cone-default-boundary": (
                "LineCone",
                "ASMTPlanarJoint",
                "offset",
                1.5,
            ...
            "assembly-distance-line-torus-default-boundary": (
                "LineTorus",
                "ASMTPlanarJoint",
                "offset",
                1.5,
            ...
            "assembly-distance-curve-cylinder-default-boundary": (
                "CurveCylinder",
                "ASMTPlanarJoint",
                "offset",
                1.5,
            ...
            "assembly-distance-curve-sphere-default-boundary": (
                "CurveSphere",
                "ASMTPlanarJoint",
                "offset",
                1.5,
            ...
            "assembly-distance-curve-cone-default-boundary": (
                "CurveCone",
                "ASMTPlanarJoint",
                "offset",
                1.5,
            ...
            "assembly-distance-curve-torus-default-boundary": (
                "CurveTorus",
                "ASMTPlanarJoint",
                "offset",
                1.5,
    ...
    def test_c3m6_assembly_distance_type_reference_classification_exposes_solver_dto(self) -> None:
        ...
        extended_cases = [
            ...
            {
                "case": "curve_cylinder_expected_backed_default_boundary",
                "reference1": ellipse_edge,
                "reference2": cylinder_face,
