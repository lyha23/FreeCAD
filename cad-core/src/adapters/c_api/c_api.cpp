             ...
             {"filling",
              {
                  ...
                  {"status", "supported_expected_backed_first_batch_with_c5m8_s1_source_backed_known_gap"},
             ...
             {"producer_matrix",
              {
                  ...
                  {"pipeshell",
                   {{"status", "done_expected_backed_first_batch"},
                    ...
                    {"remaining", nlohmann::json::array()}}},
                  {"part_filling",
                   {{"status", "done_expected_backed_first_batch_plus_c5m8_s1_source_backed_known_gap"},
                    {"covered",
                     {"maker_history:filling",
                      "boundary_source_evidence",
                      "closed_wire_default",
