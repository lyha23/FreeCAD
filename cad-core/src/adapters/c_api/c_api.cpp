             ...
             {"representative_solver_adapter",
              {
                  ...
                  {"fallback_reasons", {"no_grounded_part", "ondsel_solver_not_linked"}},
              }},
        ...
        {"wire_joiner",
         {
             ...
             {
                  {"status", "covered_main_path"},
                  {"mode", "producer_open_export_shape"},
                  {"covered",
                   {"producerOpenExportShape",
             ...
             {"purge_as_original_bridge",
              {
                  {"status", "covered_main_path"},
                  {"mode", "source_split_ledger_candidate"},
                  {"deleted_fields", {"purgeAsOriginalOpenEdge"}},
                  {"covered",
