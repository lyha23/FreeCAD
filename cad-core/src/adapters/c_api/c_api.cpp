             ...
             {"datum_attachment",
              {
                  ...
                  {"status", "supported_c51s5_selected_attach_engine_with_request_local_writeback"},
                  {"type_ids",
                   {"PartDesign::Point",
                    "PartDesign::Line",
                    "PartDesign::Plane",
                  ...
                  {"exact_blockers",
                   {{"datum_attach_engine_remaining_modes",
                     {{"modes",
                      ...
                      {"evidence",
                       "C51-S5 first batch supports only FlatFace, ObjectXY/ObjectXZ/ObjectYZ, ObjectOrigin/ObjectX/ObjectY/ObjectZ and NormalToEdge"}}}}},
                  {"remaining_gaps", nlohmann::json::array()},
              }},
             {"hole",
              {
