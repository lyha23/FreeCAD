             ...
             {"sweep",
              {
                  ...
                  {"source_backed_known_gaps",
                   {{"part_sweep_wrapper_expected_collector",
                     {{"status", "source_backed_known_gap"},
                      {"fields",
                       {"AuxiliarySpine",
                        "AuxiliaryCurvilinear",
                        "SpineSupport",
                      ...
                      {"source_authority",
                       {"/Users/li/Chili3DProject/FreeCAD/src/Mod/Part/App/BRepOffsetAPI_MakePipeShellPyImp.cpp",
                        ...
                        "/Users/li/Chili3DProject/FreeCAD/src/Mod/Part/App/PartFeatures.cpp"}},
                      {"delete_condition",
                       "Replace each source-backed C5-M10 fixture with FreeCADCmd Part.BRepOffsetAPI_MakePipeShell wrapper expected payloads after the collector records stable shape_summary and object_fields.advanced metadata; do not derive expected geometry from cad-core output."}}}}},
                  {"non_goals",
                  ...
                  {"remaining_gaps", {"part_sweep_wrapper_expected_collector"}},
              }},
             {"filling",
              {
                  // FreeCAD:
