             ...
             {"revolution_groove",
              {
                  ...
                  {"status", "supported_c5m1_angle_twoangles_throughall_with_diagnostics"},
                  ...
                  {"deferred",
                   {"Type=UpToFirst",
                    ...
                    "Datum/App line axis native oracle"}},
                  {"remaining_gaps",
                   {"partdesign_revolution_groove_brepfeat_upto",
                    "partdesign_revolution_groove_profile_subshape",
                    "partdesign_revolution_fuse_order_feature_first"}},
              }},
             {"boolean",
              {
                  ...
                  {"status", "supported_c5m2_boolean_body_ownership_with_diagnostics"},
             ...
             {"loft",
              {
                  ...
                  {"status", "supported_profile_section_body_first_slice_with_c5m3_diagnostics"},
                  ...
                  {"deferred",
                   {"explicit Profile/Sections sub-element selection beyond Vertex",
                    "Closed=true native oracle captured as known gap with stable diagnostic",
                    "multi-wire profile/section ordering native oracle captured as known gap with stable diagnostic",
             ...
             {"pipe",
              {
                  ...
                  {"status", "supported_c5m3_profile_spine_multisection_transition_with_diagnostics"},
                  ...
                  {"diagnostics",
                   {"missing_property",
                    ...
                    "unsupported_property"}},
                  {"deferred",
                   {"Transition=Round corner native expected",
                    "Mode=Auxiliary",
                    "Mode=Binormal",
                    "Mode=Fixed orientation parity",
                  ...
                  {"remaining_gaps",
                   {"partdesign_pipe_auxiliary_spine",
                    ...
                    "partdesign_pipe_round_corner",
                    "partdesign_pipe_fixed_mode",
             ...
             {"datum_attachment",
              {
                  ...
                  // and can write back AttachmentSupport subnames, so C5-M4 keeps selected
                  // MapMode support diagnostic-backed until that request-local engine exists.
                  {"status", "supported_existing_placement_link_slice_with_c5m4_diagnostic_gate"},
                  {"type_ids",
                   {"PartDesign::Point",
                    "PartDesign::Line",
                    "PartDesign::Plane",
                  ...
                  {"deferred",
                   {"GUI Attachment editor",
                    ...
                    "selected Datum AttachmentSupport/MapMode support",
                    "AttachmentOffset/MapReversed/MapPathParameter solving",
                    "AttachmentSupport shadow-sub downstream writeback",
