             ...
             {"loft",
              {
                  ...
                  {"status", "supported_profile_linearize_complex_expected_backed"},
                  {"type_ids", {"Part::Loft"}},
                  {"payload_keys",
                   {"Objects[].TypeId",
                  ...
                  {"remaining_gaps", {"part_loft_subelement_assignment_native_hidden"}},
                  {"non_goals",
                     ...
                     {{"status", "narrowed_freecadcmd_wrapper_build_blocker"},
                      ...
                      {"freecadcmd_evidence",
                       {{"helper", "Part.BRepOffsetAPI_MakePipeShell"},
                        ...
                        {"error", "OCCError: NCollection_Array1::Value"}}},
                      {"delete_condition",
                       "Replace after the Location overload is collectable and combined auxiliary/located section/tolerance metadata returns stable shape_summary."}}}}},
                  {"non_goals",
             ...
             {"filling",
              {
                  ...
                  {"status", "supported_expected_backed_with_c5m13_param_subset_closeout"},
                  ...
                  {"narrowed_gaps",
                   {{"filling_surface_native_helper_blocker",
                     {{"status", "narrowed_freecadcmd_native_helper_blocker"},
                      {"fields", {"Surface"}},
                      {"fixtures", {"c5m8/part-filling-initial-surface-boundary"}},
                      {"freecadcmd_evidence",
                       {{"helper", "Part.makeFilledFace"},
                        {"error", "TypeError: argument 2 must be , not Part.Face"}}},
                      {"delete_condition",
                    ...
                    {"filling_params_pts_anisotropy_tol_g1_g2_max_segments_blocker",
                     {{"status", "narrowed_freecadcmd_signal_blocker"},
             ...
             {"geomplate",
              {
                  ...
                  {"narrowed_gaps",
                   {{"g1_curve_on_surface_native_hidden_diagnostic_only",
                     {{"status", "native_hidden_diagnostic_only"},
                      {"fields", {"G1 curve-on-surface"}},
                      {"fixtures", {"c5m7/part-geomplate-g1-curve-on-surface"}},
                      {"freecadcmd_evidence",
                       {{"helper", "Part.GeomPlate.BuildPlateSurface"},
                        {"error", "Curve must be on a Surface"},
                        {"criteria_setter", "NotImplementedError"}}},
                      {"delete_condition",
                       "Delete after a stable FreeCADCmd helper path can construct Adaptor3d_CurveOnSurface G1 expected."}}},
                    {"projected_curve2d_no_initial_surface_v1_v2_native_oracle_blocker",
                     {{"status", "narrowed_native_oracle_blocker"},
                      {"fields", {"ProjectedCurve2d without InitialSurface"}},
                      {"fixtures", {"c5m7/part-geomplate-projected-curve2d"}},
             ...
             {"datum_attachment",
              {
                  ...
                  {"status", "supported_c51x_selected_attach_engine_with_datum_3d_plane_family"},
                  {"type_ids",
                   {"PartDesign::Point",
                    "PartDesign::Line",
                    "PartDesign::Plane",
             ...
             {"producer_matrix",
              {
                  ...
                  {"pipeshell",
                   {{"status", "done_expected_backed_first_batch"},
                    ...
                    {"remaining", nlohmann::json::array()}}},
                  {"part_filling",
                   {{"status", "done_expected_backed_first_batch_plus_c5m13_param_subset_closeout"},
                    {"covered",
                     {"maker_history:filling",
                      "boundary_source_evidence",
                      "closed_wire_default",
