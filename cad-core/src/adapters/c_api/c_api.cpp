        ...
        {"distance_type_basic_geometry",
         {
             ...
             {"remaining_radius_gaps",
              {"LineCircle",
               ...
               "PointCylinder",
               "PointSphere"}},
             {"non_goals", {"PointCurve", "CurvePlane", "Other", "GUI/session", "persistent_solver_state"}},
         }},
        {"subshape_marker_placement",
         {
             ...
             {"non_goals",
              {"radius_bearing_distance_type",
               "curve_default_distance_type",
               "GUI/session",
               "persistent_solver_state",
               "connector_only_subshape_marker_shortcut",
