             ...
             {"sweep",
              {
                  ...
                  {"narrowed_gaps",
                   {{"part_sweep_support_mode_fixture_diagnostic_only",
                     {{"status", "narrowed_diagnostic_only_blocker"},
                      {"fields", {"SpineSupport", "SupportMode"}},
                      {"fixtures", {"c5m10/part-sweep-support-mode-diagnostics"}},
                      {"freecadcmd_evidence",
                       {{"helper", "Part.BRepOffsetAPI_MakePipeShell"},
                        {"runtime_helper", "Part.BRepOffsetAPI.MakePipeShell"},
                        {"reason", "fixture has no valid SpineSupport representative"}}},
                      {"delete_condition",
                       "Add or reuse a valid SpineSupport representative, collect wrapper expected shape_summary and object_fields.advanced.spine_support, and keep invalid support/mode diagnostics focused."}}},
