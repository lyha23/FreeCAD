                    ...
                    "advanced_approximation_params_are_not_full_advanced_support",
	                  ...
	                  {"field_boundaries",
	                   {{"expected_backed",
	                    ...
	                    {"diagnostic_backed",
	                     {"CurveConstraint criteria setters unsupported_curve_criteria",
                    ...
                    {"projected_curve2d_no_initial_surface_v1_v2_native_oracle_blocker",
                      ...
                      {"delete_condition",
	                    ...
	                    {"curve_constraint_criteria_setters_not_implemented",
	                     {{"status", "released_c6m6_diagnostic_boundary_not_implemented"},
	                      ...
	                      {"s4_diagnostic_evidence",
	                       {{"status", "published_c6m6_diagnostic_boundary"},
	                        {"fixtures", {"c5m7/part-geomplate-curve-criteria-diagnostic"}},
	                        {"diagnostics", {"unsupported_curve_criteria"}},
	                        {"focused_tests",
	                         {"tests.test_p8_features -k geomplate",
	                          "tests.test_expected_fixtures -k geomplate"}}}},
	                      {"diagnostic", "unsupported_curve_criteria"},
                      {"source_authority",
                      ...
                      {"delete_condition",
	                       "Delete only after all three FreeCAD CurveConstraint criteria setters stop raising NotImplementedError and CAD Core adds request-local CurveConstraint criteria fixtures."}}},
