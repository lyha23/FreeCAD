        ...
        {"distance_type_extended_geometry",
         {
             ...
             {"solver_joint_classes",
              {{"LineCircle", {"ASMTRevCylJoint"}},
               ...
               {"PointCurve", {"ASMTPointInPlaneJoint"}},
               ...
               {"PlaneCone", {"ASMTPlanarJoint"}},
               {"CylinderCone", {"ASMTPlanarJoint"}},
               {"ConeCone", {"ASMTPlanarJoint"}},
               {"ConeTorus", {"ASMTPlanarJoint"}},
               {"ConeSphere", {"ASMTPlanarJoint"}},
               {"PointCone", {"ASMTPlanarJoint"}},
               {"PointTorus", {"ASMTPlanarJoint"}},
               {"LineCylinder", {"ASMTPlanarJoint"}},
               {"LineSphere", {"ASMTPlanarJoint"}},
               {"LineCone", {"ASMTPlanarJoint"}},
               {"LineTorus", {"ASMTPlanarJoint"}},
               {"CurvePlane", {"ASMTPlanarJoint"}},
               {"CurveCylinder", {"ASMTPlanarJoint"}},
               {"CurveSphere", {"ASMTPlanarJoint"}},
               {"CurveCone", {"ASMTPlanarJoint"}},
               {"CurveTorus", {"ASMTPlanarJoint"}},
               {"Other", {"ASMTPlanarJoint"}}}},
             {"scalar_fields", {"distance_ij", "offset"}},
             {"evidence_fields",
             ...
             {"deferred_diagnostic_cases", nlohmann::json::array()},
             {"default_or_todo_boundaries", nlohmann::json::array()},
             {"diagnostic_expected_count", 0},
             {"non_goals",
              {"GUI/session", "persistent_solver_state"}},
         }},
        {"subshape_marker_placement",
         {
             ...
             {"covered",
              {"object_level_baseline",
               ...
               "non_identity_bundled_offsetPlc_marker",
             ...
             {"conic_curves",
              {
                  ...
                  {"fixtures",
                   {"part-primitives/part-hyperbola-edge",
                    "part-primitives/part-parabola-edge",
                    "part-primitives/part-conic-edge-invalid-params",
                    "part-primitives/part-conic-edge-extrusion",
                    "part-ruled-surface/part-ruled-surface-conic-line",
                    "sketcher-geometry/sketch-hyperbola-arc-profile",
                    "sketcher-geometry/sketch-parabola-arc-profile",
                    "sketcher-geometry/sketch-conic-arcs-construction-filter",
                    "sketcher-geometry/sketch-conic-arcs-external-geometry-projected",
                    "sketcher-geometry/sketch-conic-arcs-external-geometry-native"}},
                  {"diagnostics",
                   {"invalid_part_conic_axis",
                    "invalid_part_conic_curve_kind",
                    "invalid_part_conic_focal",
                  ...
                  {"distance_type_publication",
                   {{"source_capability", "assembly.ondsel_solver_adapter.distance_type_extended_geometry"},
                    {"deferred_diagnostic_cases", nlohmann::json::array()},
                    {"default_or_todo_boundaries", nlohmann::json::array()},
                    {"status", "published_as_assembly_expected_backed_supported"}}},
                  {"non_goals",
                   {"gui_conic_edit",
             ...
             {"project_on_surface",
              {
                  ...
                  // child movement.
                  {"status", "supported_expected_backed_product_contract"},
                  ...
                  {"field_boundaries",
                   {{"expected_backed",
                    ...
                    {"historical_native_evidence",
                     {"native ProjectOnSurface mapper/history ownership unavailable through the "
                      "current FreeCAD public history API"}},
                  ...
                  {"narrowed_gaps",
                   {{"native_project_on_surface_mapper_history_oracle_unavailable",
                     {{"status", "native_oracle_unavailable_retained"},
                      {"route", "product_contract_non_parity"},
                      {"product_contract",
                       {{"provenance", "cad_core_projection_item_ledger"},
                        {"freecad_expected_status", "native_oracle_unavailable"}}},
                      {"fixtures",
                       {"part-project-on-surface/part-project-on-surface-edge-provenance",
                        "part-project-on-surface/part-project-on-surface-wire-split-provenance",
                        "part-project-on-surface/part-project-on-surface-face-rebuild-provenance",
                      ...
                      {"freecad_source_authority",
                       ...
                       "tryExecute()"},
                      {"delete_condition",
                       "Only revisit if a future FreeCAD native artifact exposes stable "
                       "ProjectOnSurface mapper/history ownership expected evidence; do not block "
                       "the CAD Core request-local product contract"}}}}},
                  {"remaining_gaps", nlohmann::json::array()},
                     ...
                     {{"status",
                      ...
                      {"product_contract",
                       {{"provenance", "cad_core_product_contract_non_parity"},
                        {"product_path", "part-loft/part-loft-subelement-product"},
                        {"diagnostic_path", "part-loft/part-loft-subelement-product-invalid"},
                   ...
                   {{"expected_backed",
                    ...
                    {"diagnostic_backed",
                     {"missing_link_target",
                      ...
                      "HelperLifecycle native diagnostics"}},
                    {"non_goal",
                     ...
                     {{"status", "released_c6m4_product_contract_non_parity"},
                      ...
                      {"product_contract",
                       {{"provenance", "cad_core_product_contract_non_parity"},
                        ...
                        {"product_path", "part-sweep/part-sweep-located-profile-product"},
                        {"diagnostic_paths",
                         {"part-sweep/part-sweep-located-profile-diagnostics",
                          "part-sweep/part-sweep-located-profile-bool-diagnostics"}}}},
                      {"delete_condition",
                    ...
                    {"part_sweep_advanced_combined_freecadcmd_wrapper_build_blocker",
                     {{"status", "released_c6m4_product_contract_non_parity"},
                      ...
                      {"product_contract",
                       {{"provenance", "cad_core_product_contract_non_parity"},
                        {"freecadcmd_location_overload_status", "notCollected"},
                        {"product_path", "part-sweep/part-sweep-advanced-combined-product"},
                        {"covered_combination",
                  ...
                  {"narrowed_gaps",
                   {{"filling_surface_native_helper_blocker",
                     {{"status", "released_c6m5_product_contract_non_parity"},
                      {"fields", {"Surface"}},
                      {"fixtures", {"part-filling/part-filling-initial-surface-boundary"}},
                      {"s3_product_contract_evidence",
                       {{"status", "published_c6m5_product_contract_non_parity"},
                        {"fixtures", {"part-filling/part-filling-surface-initial-face-product"}},
                        {"object_fields",
                    ...
                    {"filling_support_order_g1_native_helper_blocker",
                     {{"status", "released_c6m5_product_contract_non_parity"},
                      ...
                      {"fixtures", {"part-filling/part-filling-support-order-edge-face"}},
                      {"s3_product_contract_evidence",
                       {{"status", "published_c6m5_product_contract_non_parity"},
                        {"fixtures",
                         {"part-filling/part-filling-support-order-c0-g1-g2-product",
                    ...
                    {"filling_params_pts_anisotropy_tol_g1_g2_max_segments_blocker",
                     {{"status", "released_c6m5_product_contract_non_parity"},
                      ...
                      {"fixtures", {"part-filling/part-filling-non-default-params"}},
                    ...
                    {"filling_params_all_native_helper_blocker",
                     {{"status", "released_c6m5_product_contract_non_parity"},
                      ...
                      {"s4_product_contract_evidence",
                       {{"status", "published_c6m5_product_contract_non_parity"},
                        {"fixtures", {"part-filling/part-filling-explicit-params-product"}},
                    ...
                    {"filling_non_boundary_support_order_native_helper_blocker",
                     {{"status", "released_c6m5_product_contract_non_parity"},
                      ...
                      {"fixtures", {"part-filling/part-filling-non-boundary-edge-support"}},
                      {"s4_product_contract_evidence",
                       {{"status", "published_c6m5_product_contract_non_parity"},
                        {"fixtures",
                         {"part-filling/part-filling-non-boundary-support-order-product",
                         ...
                         {{"status",
                          ...
                          {"s3_product_contract_evidence",
                           {{"status", "published_c6m6_product_contract_non_parity"},
                            {"fixtures", {"part-geomplate/part-geomplate-g1-curve-on-surface-contract"}},
                            {"focused_tests",
                    ...
                    {"projected_curve2d_no_initial_surface_v1_v2_native_oracle_blocker",
                         {{"status", "released_c6m6_request_local_contract_native_oracle_blocker"},
                          ...
                          {"fixtures",
                           {"part-geomplate/part-geomplate-projected-curve2d",
                            "part-geomplate/part-geomplate-projected-curve2d-no-initial-surface"}},
                          {"expected_backed_subsets", {"part-geomplate/part-geomplate-projected-curve2d-initial-surface"}},
                          {"s3_product_contract_evidence",
                           {{"status", "published_c6m6_product_contract_non_parity"},
                            {"fixtures", {"part-geomplate/part-geomplate-projected-curve2d-no-initial-surface"}},
                            {"expected_backed_subsets",
                             {"part-geomplate/part-geomplate-projected-curve2d-initial-surface"}},
                            {"focused_tests",
                             {"tests.test_p8_features -k geomplate",
                      ...
                      {"delete_condition",
                             ...
                             {{"status", "native_non_parity_historical_evidence_request_local_supported"},
                              ...
                              {"native_non_parity_evidence",
                               {{"status", "retained_as_historical_native_setter_blocker"},
                                {"fixtures", {"part-geomplate/part-geomplate-curve-custom-criteria"}},
                                {"diagnostics", {"invalid_parameter"}},
                                {"focused_tests",
                                 {"tests.test_p8_features -k geomplate",
                                  "tests.test_expected_fixtures -k geomplate"}}}},
                        ...
                        {"platesurface_curves_wrapper_lifecycle",
                         {{"status", "released_c6m6_non_goal_boundary_wrapper_lifecycle"},
                          ...
                          {"fixtures", {"part-geomplate/part-geomplate-wrapper-boundary"}},
                  ...
                  {"up_to_shape_multi_face",
                   {
                       ...
                       {"failure_fixtures",
                        {{"offset", "partdesign-extrude/pocket-up-to-shape-multiple-faces-offset"},
                         {"invalid_subshape", "partdesign-extrude/pocket-up-to-shape-edge-subshape"}}},
                       {"diagnostics", {"unsupported_property", "unsupported_subshape_kind"}},
                   }},
                  {"remaining_gaps", nlohmann::json::array()},
              }},
             {"body_chain",
             ...
             {"shape_binder",
              {
                  ...
                  {"covered",
                   {"whole_shape_support",
                    ...
                    "Body group replay as non-base feature"}},
                  {"fixtures",
                   {"partdesign-binder/shape-binder-whole-box-cross-body",
                    "partdesign-binder/shape-binder-face-edge-vertex-multi-subshape",
                    "partdesign-binder/shape-binder-trace-support-placement",
                    "partdesign-binder/shape-binder-datum-fallback-line-plane-point",
                    "partdesign-binder/shape-binder-subshape-binder-element-map-namedshape-body-replay"}},
             ...
             {"sub_shape_binder",
              {
                  ...
                  {"fixtures",
                   {"partdesign-binder/subshape-binder-basic-support-whole-face-edge-list",
                    "partdesign-binder/subshape-binder-makeface-offset-fuse-refine",
                    "partdesign-binder/subshape-binder-setlinks-normalization-diagnostics",
                    "partdesign-binder/subshape-binder-relative-context-nested-route",
                    "partdesign-binder/subshape-binder-profile-consumer-before-after-pad",
                    "partdesign-binder/shape-binder-subshape-binder-element-map-namedshape-body-replay",
                    "partdesign-binder/subshape-binder-bindmode-synchronized-frozen-detached",
                    "partdesign-binder/subshape-binder-copy-on-change-disabled-enabled-mutated-partialload"}},
                  {"diagnostics",
                   {"missing_property",
                    "missing_link_target",
                    "invalid_subshape",
             ...
             {"revolution_groove",
              {
                  ...
                  {"supported",
                   {"Type=Angle",
                    ...
                    "Profile.StableSubList=SketchInternalFaceAlias",
                  ...
                  {"fixtures",
                   {"partdesign-revolve/partdesign-revolution-axis-angle-body",
                    "partdesign-revolve/partdesign-groove-axis-angle-body",
                    "partdesign-revolve/partdesign-revolution-two-angles-body",
                    "partdesign-revolve/partdesign-groove-two-angles-body",
                    "partdesign-revolve/partdesign-groove-through-all-body",
                    "partdesign-revolve/partdesign-revolution-part-edge-axis",
                    "partdesign-revolve/partdesign-revolved-zero-sum-diagnostic",
                    "partdesign-revolve/partdesign-revolved-upto-diagnostics",
                    "partdesign-revolve/partdesign-revolved-profile-fuse-diagnostics",
                    "partdesign-revolve/partdesign-revolution-internalface-profile",
                    "partdesign-revolve/partdesign-revolution-featurefirst-body",
                    "partdesign-revolve/partdesign-revolution-datumline-axis",
                    "partdesign-revolve/partdesign-revolution-appline-axis",
                    "partdesign-revolve/partdesign-revolution-sketch-axisn",
                    "partdesign-revolve/partdesign-revolution-uptoface-body",
                    "partdesign-revolve/partdesign-revolution-uptofirst-body",
                    "partdesign-revolve/partdesign-revolution-uptolast-body",
                  ...
                  {"field_boundaries",
                   {{"expected_backed",
                     {"Type=Angle",
                      ...
                      "Revolution Type=UpToFace",
                      "Groove Type=ThroughAll",
                      "Groove Type=UpToFirst product diagnostic contract",
                      "Groove Type=UpToFace product diagnostic contract"}},
                    {"historical_native_evidence",
                    ...
                    {"product_contract",
                     {"C12-M7 approved CAD Core request-local Groove UpTo diagnostic contract",
                      "freecad_native_parity=false"}},
                    {"narrowed_gap", {"partdesign_groove_upto_brepfeat_cut_native_failure"}}}},
                  {"narrowed_gaps",
                   {{"partdesign_groove_upto_brepfeat_cut_native_failure",
                     {{"status", "published_c12m7_product_diagnostic_contract"},
                      {"route", "product_diagnostic_contract_non_parity"},
                      {"freecad_source_authority",
                      ...
                      {"product_diagnostic_contract",
                       {{"contract",
                         "CAD Core request-local PartDesign::Groove UpTo BRepFeat_MakeRevol diagnostic"},
                        {"freecad_native_parity", false},
                        {"diagnostic_codes", {"execution_failed", "execution_failed"}},
                        {"primary_diagnostic",
                        ...
                        {"secondary_diagnostic",
                         {{"code", "execution_failed"},
                          {"message", "Could not revolve the sketch"},
                          {"object", "Groove"},
                          {"severity", "error"}}},
                        {"object_status", {{"Groove", "error"}, {"Body", "skipped"}}}}},
                      {"fixtures",
                       {"partdesign-revolve/partdesign-groove-uptofirst-body",
                        "partdesign-revolve/partdesign-groove-uptoface-body"}},
                      {"delete_condition",
                       "Delete only after the same FreeCAD/LibPack oracle baseline proves "
                       "native Groove UpToFirst and UpToFace success and a follow-up package "
                       "replaces this product diagnostic contract with geometry expected parity."},
                      {"reopen_condition",
                       "Reopen only as one Groove UpToFirst plus UpToFace batch; do not promote "
                       "one fixture, rewrite native failure as expected-backed success, or drop "
                       "the C12-M7 native failure note."}}}}},
             ...
             {"boolean",
              {
                  ...
                  {"fixtures",
                   {"partdesign-boolean/partdesign-boolean-cut-body-tool",
                    "partdesign-boolean/partdesign-boolean-fuse-body-tool",
                    "partdesign-boolean/partdesign-boolean-common-body-tool",
                    "partdesign-boolean/partdesign-boolean-deferred-diagnostics",
                    "partdesign-boolean/partdesign-boolean-allow-compound-multisolid",
                    "partdesign-boolean/partdesign-boolean-multi-tool-ownership",
                    "partdesign-boolean/partdesign-boolean-multisolid-rejected",
                    "partdesign-boolean/partdesign-boolean-tool-missing-shape-diagnostic",
                    "partdesign-boolean/partdesign-boolean-compound-body-tip",
                    "partdesign-boolean/partdesign-boolean-compound-disallowed",
                    "partdesign-boolean/partdesign-boolean-section-standalone",
                    "partdesign-boolean/partdesign-boolean-section-body-tip-diagnostic",
                    "partdesign-boolean/partdesign-boolean-section-no-intersection"}},
                  {"diagnostics",
                   {"missing_property",
                    "missing_link_target",
                    "missing_target",
             ...
             {"loft",
              {
                  ...
                  {"fixtures",
                   {"partdesign-loft/partdesign-loft-additive-body",
                    ...
                    "partdesign-loft/partdesign-loft-closed-multisection-legacy-c5m3",
                    "partdesign-loft/partdesign-loft-multiwire-ordering-legacy-c5m3",
                    "partdesign-loft/partdesign-loft-allow-compound-diagnostic-legacy-c5m3",
             ...
             {"datum_attachment",
              {
                  ...
                  {"supported",
                   {"DatumPoint Placement vertex",
                    ...
                    "DatumPlane reference frame / plane provider",
                  ...
                  {"fixtures",
                   {"partdesign-datum/datum-coordinate-system-reference-axis",
                    "partdesign-datum/datum-coordinate-system-sketch-support",
                    "partdesign-body/body-origin-link-placement",
                    "partdesign-datum/partdesign-datum-attachment-deferred-diagnostics",
                    "partdesign-datum/partdesign-datum-attachment-mapmode-diagnostics",
                    "partdesign-datum/partdesign-datum-selected-mapmodes",
                    "partdesign-datum/partdesign-datum-user-offset-plane-sketch",
                    "partdesign-datum/partdesign-datum-offset-reverse-writeback",
                    "partdesign-datum/partdesign-datum-point-single-input-modes",
                    "partdesign-datum/partdesign-datum-point-proximity-modes",
                    "partdesign-datum/partdesign-datum-point-proximity-diagnostics",
                    "partdesign-datum/partdesign-datum-line-family-modes",
                    "partdesign-datum/partdesign-datum-line-family-diagnostics",
                    "partdesign-datum/partdesign-datum-3d-plane-modes",
                    "partdesign-datum/partdesign-datum-3d-plane-diagnostics",
                    "partdesign-datum/partdesign-datum-curve-frame-modes",
                    "partdesign-datum/partdesign-datum-curve-frame-diagnostics",
                    "partdesign-datum/partdesign-datum-conic-landmark-modes",
                    "partdesign-datum/partdesign-datum-conic-landmark-diagnostics",
                    "partdesign-datum/partdesign-datum-folding-modes",
                    "partdesign-datum/partdesign-datum-folding-diagnostics"}},
                  {"diagnostics",
                   {"invalid_placement",
                    "missing_link_target",
                    "unsupported_property",
             ...
             {"hole",
              {
                  ...
                  {"native_oracle_fixtures",
                   {"partdesign-hole/hole-supported-threaded-dynamic-iso2009",
                    "partdesign-hole/hole-supported-threaded-dynamic-din7984",
                    "partdesign-hole/hole-supported-model-thread-metric",
                    "partdesign-hole/hole-point-profile",
                  ...
                  {"taper_history",
                   {
                       ...
                       {"fixtures",
                        {"partdesign-extrude/pad-length-taper",
                         "partdesign-extrude/pad-two-sides-taper",
                         "partdesign-extrude/pad-symmetric-taper",
                         "partdesign-extrude/pad-length-taper-inner-wire",
                         "partdesign-extrude/pocket-length-taper",
                         "part-extrude/part-extrusion-taper",
                         "part-extrude/part-extrusion-reverse-taper",
                         "part-extrude/part-extrusion-two-sided-taper"}},
                       {"remaining_gaps", nlohmann::json::array()},
                   }},
              }},
             {"remaining_gaps", nlohmann::json::array()},
