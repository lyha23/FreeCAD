             ...
             {"pipe",
              {
                  ...
                  {"status", "supported_c6m1_pipe_cad_core_product_extension_with_contract_boundaries"},
                  ...
                  {"deferred", nlohmann::json::array()},
                  {"exact_blockers",
                   {{"partdesign_pipe_interpolation_law_product_contract_required",
                     {{"properties", {"Transformation=Interpolation", "LawSamples"}},
                      {"source", "/Users/li/Chili3DProject/FreeCAD/src/Mod/PartDesign/App/FeaturePipe.cpp::TransformEnums"},
                      {"evidence", "Interpolation is an enum label only; C6-M1 keeps product_contract_required until a LawSamples contract is approved"}}}}},
                  {"remaining_gaps", {"partdesign_pipe_interpolation_law_product_contract_required"}},
              }},
             {"datum_attachment",
              {
