...
- 不支持声明：`Linearize=true` 后处理、face / vertex profile expected、复杂 profile family、完整 Part surface family；invalid sections 只发布为 diagnostics / expected-backed failure boundary，不伪造 shape。
