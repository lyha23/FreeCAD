...
- 尚缺完整 MapperHistory 生命周期、FaceMaker / WireJoiner history 到正式 `ElementMap` 的传播、复杂一对多 / 删除 / mapped postfix 引用恢复、ExternalGeometryExtension 全状态机和旧 fallback 删除。
