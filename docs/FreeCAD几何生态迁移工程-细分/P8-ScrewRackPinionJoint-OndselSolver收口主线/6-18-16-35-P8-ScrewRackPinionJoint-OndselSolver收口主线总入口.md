...
| S0 声明口径 | `工作步骤细分/6-18-16-36-P8-ScrewRackPinionJoint-S0-声明口径与live基线复核.md` | 冻结 claims、非目标和 current unsupported 基线 |
| S1 FreeCAD 源码候选 | `工作步骤细分/6-18-16-37-P8-ScrewRackPinionJoint-S1-FreeCAD源码候选矩阵.md` | 建立 source authority 和 candidate TSV |
