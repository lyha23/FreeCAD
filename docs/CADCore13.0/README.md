...
| C13-M5 FreeCADExpected 发布对齐 | active / S1 已完成，S2 pending | [C13-M5-FreeCADExpected发布对齐批次](C13-M5-FreeCADExpected发布对齐批次/README.md) |
...
- C13-M5 S1 已关闭：新增 strict comparator 与 cad-core-res 生成入口，`c4m6` 可生成 structured red report；S2 继续把红灯差异机器化归类为 owner/决策/实现路径。
