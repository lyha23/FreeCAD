# C7-M6 S3 native oracle 采集与 expected 固化
...
3. 如果采到 native oracle，expected 必须记录 FreeCAD version、placement / constraint evidence、solver DTO evidence、writeback summary 和 source authority。
